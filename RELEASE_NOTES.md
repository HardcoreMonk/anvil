...
적응이며 upstream 변경과 구분된다. `anvil-v0.4.0` 및 upstream 시리즈별 마일스톤은
개발 내역으로 보존된다.
...
>   release build), `anvil-ephemera-v0.6.4`(`04e2a12`, e2e 334✓, source-only —
>   release/installer pipeline은 v0.7.0 도입이라 v0.6.4 자체 패키징 불가).
