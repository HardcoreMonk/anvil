	...
	return []toolRegistration{
		{
			...
			register: func(server *mcp.Server, tool *mcp.Tool, tools *anvilmcp.Tools) {
				anvilmcp.AddToolGeminiSafe(server, tool, tools.MCPSpawnVM)
			},
		},
		{
			name:        "anvil_run_task",
			...
			register: func(server *mcp.Server, tool *mcp.Tool, tools *anvilmcp.Tools) {
				anvilmcp.AddToolGeminiSafe(server, tool, tools.MCPRunTask)
			},
		},
		{
			name:        "anvil_copy_in",
			...
			register: func(server *mcp.Server, tool *mcp.Tool, tools *anvilmcp.Tools) {
				anvilmcp.AddToolGeminiSafe(server, tool, tools.MCPCopyIn)
			},
		},
		{
			name:        "anvil_copy_out",
			...
			register: func(server *mcp.Server, tool *mcp.Tool, tools *anvilmcp.Tools) {
				anvilmcp.AddToolGeminiSafe(server, tool, tools.MCPCopyOut)
			},
		},
		{
			...
			register: func(server *mcp.Server, tool *mcp.Tool, tools *anvilmcp.Tools) {
				anvilmcp.AddToolGeminiSafe(server, tool, tools.MCPHealth)
			},
		},
		{
			name:        "anvil_stop_vm",
			...
			register: func(server *mcp.Server, tool *mcp.Tool, tools *anvilmcp.Tools) {
				anvilmcp.AddToolGeminiSafe(server, tool, tools.MCPStopVM)
			},
		},
		{
			...
			register: func(server *mcp.Server, tool *mcp.Tool, tools *anvilmcp.Tools) {
				anvilmcp.AddToolGeminiSafe(server, tool, tools.MCPDeleteVM)
			},
		},
		{
			...
			register: func(server *mcp.Server, tool *mcp.Tool, tools *anvilmcp.Tools) {
				anvilmcp.AddToolGeminiSafe(server, tool, tools.MCPCreateSnapshot)
			},
		},
		{
			...
			register: func(server *mcp.Server, tool *mcp.Tool, tools *anvilmcp.Tools) {
				anvilmcp.AddToolGeminiSafe(server, tool, tools.MCPListSnapshots)
			},
		},
		{
			...
			register: func(server *mcp.Server, tool *mcp.Tool, tools *anvilmcp.Tools) {
				anvilmcp.AddToolGeminiSafe(server, tool, tools.MCPRestoreSnapshot)
			},
		},
		{
			...
			register: func(server *mcp.Server, tool *mcp.Tool, tools *anvilmcp.Tools) {
				anvilmcp.AddToolGeminiSafe(server, tool, tools.MCPDeleteSnapshot)
			},
		},
		{
			...
			register: func(server *mcp.Server, tool *mcp.Tool, tools *anvilmcp.Tools) {
				anvilmcp.AddToolGeminiSafe(server, tool, tools.MCPReplicateSnapshot)
			},
		},
		{
			...
			register: func(server *mcp.Server, tool *mcp.Tool, tools *anvilmcp.Tools) {
				anvilmcp.AddToolGeminiSafe(server, tool, tools.MCPSpawnFlock)
			},
		},
		{
			...
			register: func(server *mcp.Server, tool *mcp.Tool, tools *anvilmcp.Tools) {
				anvilmcp.AddToolGeminiSafe(server, tool, tools.MCPCreateRoutedFlockMembers)
			},
		},
		{
			...
			register: func(server *mcp.Server, tool *mcp.Tool, tools *anvilmcp.Tools) {
				anvilmcp.AddToolGeminiSafe(server, tool, tools.MCPListFlocks)
			},
		},
		{
			...
			register: func(server *mcp.Server, tool *mcp.Tool, tools *anvilmcp.Tools) {
				anvilmcp.AddToolGeminiSafe(server, tool, tools.MCPGetFlock)
			},
		},
		{
			...
			register: func(server *mcp.Server, tool *mcp.Tool, tools *anvilmcp.Tools) {
				anvilmcp.AddToolGeminiSafe(server, tool, tools.MCPDeleteFlock)
			},
		},
		{
			...
			register: func(server *mcp.Server, tool *mcp.Tool, tools *anvilmcp.Tools) {
				anvilmcp.AddToolGeminiSafe(server, tool, tools.MCPPostTownWall)
			},
		},
		{
			...
			register: func(server *mcp.Server, tool *mcp.Tool, tools *anvilmcp.Tools) {
				anvilmcp.AddToolGeminiSafe(server, tool, tools.MCPTownWallHistory)
			},
		},
	}
}
